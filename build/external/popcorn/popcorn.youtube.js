...
Popcorn.player( "youtube", {
  _setup: function( options ) {
    ...
    container.id = media.id + "_" + Popcorn.guid(); // media.id might be undefined
    ...
    var youtubeInit = function() {
      ...
      onYouTubePlayerReady[ container.id ] = function() {
        ...
        Popcorn.player.defineProperty( media, "autoplay", {
          set: function( val ) {
              if( val != null )
                autoplay = val;
            return autoplay;
      ...
      swfobject.embedSWF( "//www.youtube.com/e/" + src + "?" + query + "&rel=0&enablejsapi=1&controls=0&modestbranding=1&showinfo=0&playerapiid=" + container.id + "&version=3",
